-- Stock Journal core schema: trades, executions, goals, discipline rules, settings

-- ---------------------------------------------------------------------------
-- user_settings (1 row per authenticated user)
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- trade_executions (fills / scale-ins / scale-outs)
-- ---------------------------------------------------------------------------
...
REVOKE ALL ON public.trade_executions FROM anon;
...
-- ---------------------------------------------------------------------------
-- discipline_rules (daily checklist items)
-- ---------------------------------------------------------------------------
...
REVOKE ALL ON public.discipline_rules FROM anon;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.discipline_rules TO authenticated;
