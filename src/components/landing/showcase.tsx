...
import { LANDING_SCREENSHOT_DISPLAY_WIDTH } from "@/components/landing/app-screenshot";

type LandingShowcaseProps = {
  defaultTab?: "dashboard" | "journal" | "analytics" | "calendar";
};
...
export function LandingShowcase({ defaultTab = "dashboard" }: LandingShowcaseProps) {
  return (
    ...
    >
      <div id="analytics" className="mx-auto scroll-mt-20" style={{ maxWidth: LANDING_SCREENSHOT_DISPLAY_WIDTH }}>
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-3 text-sm text-muted-foreground sm:text-base">
            Switch between Dashboard, Journal, Analytics, and Calendar — matching the
